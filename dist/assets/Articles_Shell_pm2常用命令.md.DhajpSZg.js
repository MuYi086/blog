import{_ as s,o as a,c as i,a7 as n}from"./chunks/framework.CgLK9O2D.js";const y=JSON.parse('{"title":"pm2常用命令","description":"","frontmatter":{"tags":["Shell"]},"headers":[],"relativePath":"Articles/Shell/pm2常用命令.md","filePath":"Articles/Shell/pm2常用命令.md","lastUpdated":1719417334000}'),l={name:"Articles/Shell/pm2常用命令.md"},p=n(`<h1 id="pm2常用命令" tabindex="-1">pm2常用命令 <a class="header-anchor" href="#pm2常用命令" aria-label="Permalink to &quot;pm2常用命令&quot;">​</a></h1><h2 id="介绍" tabindex="-1">介绍 <a class="header-anchor" href="#介绍" aria-label="Permalink to &quot;介绍&quot;">​</a></h2><p><code>pm2</code> 是 <code>node</code> 进程管理工具,可以使用它简化很多 <code>node</code> 应用管理的繁琐任务，如性能监控，自动重启，负载均衡等。</p><h2 id="常用命令" tabindex="-1">常用命令 <a class="header-anchor" href="#常用命令" aria-label="Permalink to &quot;常用命令&quot;">​</a></h2><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 启动一个进程并把它命名为 uni</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">pm2</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> save</span></span></code></pre></div><h2 id="参考" tabindex="-1">参考 <a class="header-anchor" href="#参考" aria-label="Permalink to &quot;参考&quot;">​</a></h2><ol><li><a href="https://pm2.keymetrics.io/docs/usage/quick-start/" target="_blank" rel="noreferrer">PM2 Process Management Quick Start</a></li></ol><div style="display:none;" data-pagefind-meta="base64:JTdCJTIydGFncyUyMiUzQSU1QiUyMlNoZWxsJTIyJTVEJTJDJTIyZGF0ZSUyMiUzQTE3MTk0MTczMzQwMDAlN0Q="></div>`,8),h=[p];function t(e,k,r,F,d,c){return a(),i("div",null,h)}const o=s(l,[["render",t]]);export{y as __pageData,o as default};
