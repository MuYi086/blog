import{_ as s,c as n,o as a,av as i}from"./chunks/framework.B1bPfM8U.js";const F=JSON.parse('{"title":"前端工程化相关的实用git命令","description":"","frontmatter":{},"headers":[],"relativePath":"Docs/Git/前端工程化相关的实用git命令.md","filePath":"Docs/Git/前端工程化相关的实用git命令.md","lastUpdated":1718246337000}'),l={name:"Docs/Git/前端工程化相关的实用git命令.md"},p=i(`<h1 id="前端工程化相关的实用git命令" tabindex="-1">前端工程化相关的实用git命令 <a class="header-anchor" href="#前端工程化相关的实用git命令" aria-label="Permalink to &quot;前端工程化相关的实用git命令&quot;">​</a></h1><h2 id="介绍" tabindex="-1">介绍 <a class="header-anchor" href="#介绍" aria-label="Permalink to &quot;介绍&quot;">​</a></h2><p>最近在做一个网页自动检查新版本发布提示用户刷新的需求，用到了一些工程化实用的 <code>git</code> 命令，记录一下。</p><h2 id="实用命令" tabindex="-1">实用命令 <a class="header-anchor" href="#实用命令" aria-label="Permalink to &quot;实用命令&quot;">​</a></h2><p>常用的命令就不说了，大家天天提交，都有用到。以下主要记录在实现某些特殊需求时可能会用到的 <code>git</code> 命令。</p><details class="details custom-block"><summary>点我查看代码</summary><div class="language-shell vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 显示最近n次提交记录</span></span>
