...
![混淆](/Images/运维/Linux-反爬虫一些方案总结和尝试/hunxiao.png)

## 一、了解主流语言爬虫框架和爬虫原理

![原理](/Images/运维/Linux-反爬虫一些方案总结和尝试/yuanli.jpg)
...
![连接限制](/Images/运维/Linux-反爬虫一些方案总结和尝试/rateLimit.png '连接限制')
...
默认情况下,如下图所示位置:
![Nginx](/Images/运维/Linux-反爬虫一些方案总结和尝试/nginx.png 'Nginx')
...
![限制](/Images/运维/Linux-反爬虫一些方案总结和尝试/ipLimit.png '限制')
...
1. 文字混淆
![天眼查](/Images/运维/Linux-反爬虫一些方案总结和尝试/tianYanCha.png '天眼查')

1. 数字混淆
![去哪儿网](/Images/运维/Linux-反爬虫一些方案总结和尝试/qunaer.jpg '去哪儿网')
