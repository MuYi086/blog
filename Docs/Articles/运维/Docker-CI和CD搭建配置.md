...
```
创建用户
![创建用户](/Images/运维/Docker-CI和CD搭建配置/jenkins_01.png '创建用户')

实例配置
![实例配置](/Images/运维/Docker-CI和CD搭建配置/jenkins_02.png '实例配置')
...
新建一个 `nodejs` 项目
![添加描述](/Images/运维/Docker-CI和CD搭建配置/jenkins_03.png '添加描述')

![参数构建化过程](/Images/运维/Docker-CI和CD搭建配置/jenkins_04.png '参数构建化过程')

![源码管理](/Images/运维/Docker-CI和CD搭建配置/jenkins_05.png '源码管理')

![构建环境](/Images/运维/Docker-CI和CD搭建配置/jenkins_06.png '构建环境')

![构建](/Images/运维/Docker-CI和CD搭建配置/jenkins_07.png '构建')
