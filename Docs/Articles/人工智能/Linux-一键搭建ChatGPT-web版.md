...
![ChatGPT-Next-Web](/Images/人工智能/Linux-一键搭建ChatGPT-web版/ChatGPT-Next-Web_step4.png 'ChatGPT-Next-Web')
...
![添加新域名](/Images/人工智能/Linux-一键搭建ChatGPT-web版/ChatGPT-Next-Web_step1.png '添加新域名')

## 解析域名
我们将刚才在 `vercel` 网站 添加的域名解析到 `cname.vercel-dns.com` 并启用代理,保存。
![解析域名](/Images/人工智能/Linux-一键搭建ChatGPT-web版/ChatGPT-Next-Web_step3.png '解析域名')
![解析域名](/Images/人工智能/Linux-一键搭建ChatGPT-web版/ChatGPT-Next-Web_step2.png '解析域名')
